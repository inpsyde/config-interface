...
The package provides a standard interface for a common configuration value container. [`inpsyde/config`](https://github.com/inpsyde/config/) provides a flexible and thorough implementation of this interface.
